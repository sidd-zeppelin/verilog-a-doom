...
{
    // Check resources
    Verilated::stackCheck(3980);
    // Setup sub module instances
    TOP__soc_top__DOT__u_core__DOT__u_ex__DOT__u_alu__DOT__u_addsub__DOT__cla_inst.ctor(this, "soc_top.u_core.u_ex.u_alu.u_addsub.cla_inst");
    ...
    TOP.__PVT__soc_top__DOT__u_core__DOT__u_ex__DOT__u_alu__DOT__u_addsub__DOT__cla_inst = &TOP__soc_top__DOT__u_core__DOT__u_ex__DOT__u_alu__DOT__u_addsub__DOT__cla_inst;
    ...
    TOP__soc_top__DOT__u_core__DOT__u_ex__DOT__u_alu__DOT__u_addsub__DOT__cla_inst.__Vconfigure(true);
...
Vsoc_top__Syms::~Vsoc_top__Syms() {
    ...
    TOP__soc_top__DOT__u_core__DOT__u_ex__DOT__u_alu__DOT__u_addsub__DOT__cla_inst.dtor();
}
