...
class alignas(VL_CACHE_LINE_BYTES) Vsoc_top VL_NOT_FINAL : public VerilatedModel {
  ...
  public:
    ...
    Vsoc_top_rca_64b* const __PVT__soc_top__DOT__u_core__DOT__u_if__DOT__u_pc4__DOT__adder_inst;
    Vsoc_top_rca_64b* const __PVT__soc_top__DOT__u_core__DOT__u_ex__DOT__u_alu__DOT__u_addsub__DOT__rca_inst;
    Vsoc_top_rca_64b* const __PVT__soc_top__DOT__u_core__DOT__u_ex__DOT__u_bta__DOT__adder_inst;
